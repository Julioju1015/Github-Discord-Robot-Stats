      ...
      try
      {
        async function send() 
        {
          ...
          else
          {
            ...
            .setColor('#b434eb')
            .addField(`Impossible de trouver des dépôts par ${args [0]} `,` Veuillez réessayer ou rechercher un autre utilisateur.`)
          ...
          message.channel.send("Un embed a été supprimée en raison d'une inactivité")
